...
export type ValueTypes = {
    ...
    ['Mutation']: AliasType<{
        ...
        registerUser?: [
            { user: ValueTypes['RegisterUserInput'] },
            ValueTypes['User']
        ]
        __typename?: true
    }>
...
export type GraphQLTypes = {
    ['Query']: {
        ...
        getUserList: Array<GraphQLTypes['User']>
    }
    ['App']: {
        __typename: 'App'
        name: string
...
type IsInterfaced<SRC extends DeepAnify<DST>, DST> = FlattenArray<SRC> extends
    ...
    : {
          [P in keyof Pick<SRC, keyof DST>]: DST[P] extends true
              ? SRC[P]
              : IsArray<SRC[P], DST[P]>
      }
